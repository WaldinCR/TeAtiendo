...
El proyecto sigue una **Arquitectura de N-Capas (N-Tier)** combinada con un enfoque orientado al dominio (**Domain-Driven Design**) para garantizar la separación de responsabilidades y la mantenibilidad.
...
Bash
git clone [https://github.com/WaldinCR/TeAtiendo](https://github.com/WaldinCR/TeAtiendo)
Configurar Base de Datos:
Actualiza la cadena de conexión en el archivo appsettings.json dentro de TeAtiendo.API y ejecuta las migraciones:
